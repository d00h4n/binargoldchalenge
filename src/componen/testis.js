...
import testis from "../image/john.png";
import bintang from "../image/stars.png";
import left from "../image/Vector.svg";
import right from "../image/Vector-1.svg";
              ...
              <Card.Body>
                <Row>
                  <Col md={3} className="my-auto">
                    <Card.Img className="img-testi" variant="start" src={testis} />
                  </Col>
                  <Col md={9}>
                    <img src={bintang}></img>
