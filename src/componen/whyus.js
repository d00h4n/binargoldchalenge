...
import icon_thumb1 from "../image/icon_thumb.png";
import icon_thumb2 from "../image/icon_price.png";
import icon_thumb3 from "../image/icon_clock.png";
import icon_thumb4 from "../image/icon_medali.png";

function Whyus() {
  return (
    <Container id="whyus">
      <Row>
        <Col md={12} className="whyus1">
