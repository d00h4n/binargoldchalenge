      ...
      <Container id="ourservice">
        <Row>
          <Col md={6} className="service-left my-auto justify-content-evenly d-flex ">
            <img className="service" src={girlimg}></img>
          </Col>
          <Col md={6} className="service-right my-auto">
            ...
            <img className="ceklis" src={ceklis}></img>Sewa Mobil dengan Supir di Bali 12 Jam
            </div>
            <div className="servi fw-bold">
            <img className="ceklis" src={ceklis}></img>Sewa Mobil Lepas Kunci di Bali 24 Jam
            </div>
            <div className="servi fw-bold">
            <img className="ceklis" src={ceklis}></img>Sewa Mobil Jangka Panjang Bulanan
            </div>
            <div className="servi fw-bold">
            <img className="ceklis" src={ceklis}></img>Gratis Antar - Jemput Mobil di Bandara
            </div>
            <div className="servi fw-bold">
            <img className="ceklis" src={ceklis}></img>Layanan Airport Transfer / Drop in Out
            </div>
